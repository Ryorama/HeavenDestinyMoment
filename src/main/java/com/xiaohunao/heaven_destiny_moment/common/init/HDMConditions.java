...
public class HDMConditions {
    ...
    public static final FlexibleHolder<MapCodec<? extends ICondition>, MapCodec<? extends ICondition>> PLAYER = CONDITION_CODEC.registerStatic("player", () -> PlayerCondition.CODEC);
