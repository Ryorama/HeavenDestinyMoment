...
public class HDMTriggerTypes {
    ...
    public static final FlexibleHolder<TriggerType<?>,TriggerType<KillEntityTrigger>> KILL_ANY_ENTITY = TRIGGER_TYPE.registerStatic("kill_any_entity", () -> new TriggerType<>(KillEntityTrigger.class, KillEntityTrigger.CODEC));
