...
public class HDMTriggerTypes {
    ...
    public static final FlexibleHolder<TriggerType<?>,TriggerType<KillAnyEntityTrigger.Common>> KILL_ANY_ENTITY_COMMON = TRIGGER_TYPE.registerStatic("kill_any_entity_common", () -> new TriggerType<>(KillAnyEntityTrigger.Common.class,KillAnyEntityTrigger.Common.CODEC));
    public static final FlexibleHolder<TriggerType<?>,TriggerType<KillAnyEntityTrigger.Moment>> KILL_ANY_ENTITY_MOMENT = TRIGGER_TYPE.registerStatic("kill_any_entity_moment",() -> new TriggerType<>(KillAnyEntityTrigger.Moment.class,KillAnyEntityTrigger.Moment.CODEC));
    ...
    public static final FlexibleHolder<TriggerType<?>,TriggerType<KillEntityTrigger.Moment>> KILL_ENTITY_MOMENT = TRIGGER_TYPE.registerStatic("kill_entity_moment",() -> new TriggerType<>(KillEntityTrigger.Moment.class,KillEntityTrigger.Moment.CODEC));
    public static final FlexibleHolder<TriggerType<?>,TriggerType<KillEntityTrigger.Common>> KILL_ENTITY_COMMON = TRIGGER_TYPE.registerStatic("kill_entity_common",() -> new TriggerType<>(KillEntityTrigger.Common.class, KillEntityTrigger.Common.CODEC));
